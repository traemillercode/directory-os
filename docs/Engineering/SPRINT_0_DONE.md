...
- [ ] `phase:1a-core-infra` — Phase 1A: Weeks 1-3
- [ ] `phase:1b-listings` — Phase 1B: Weeks 4-6
- [ ] `phase:1c-ai` — Phase 1C: Weeks 7-9
- [ ] `phase:1d-analytics` — Phase 1D: Weeks 10-11
- [ ] `phase:1e-leads` — Phase 1E: Weeks 11-12
...
- [ ] **M1 (18 issues)**:
  - E1-1 through E1-5 (Infrastructure)
  - E2-1 through E2-8 (Database)
  - E3-1 through E3-5 (Auth)
  
- [ ] **M2 (12 issues)**:
  - E4-1 through E4-8 (Listings)
  - E5-1 through E5-4 (Import/Export)
  
- [ ] **M3 (4 issues)**:
  - E6-1 through E6-4 (AI)
  
- [ ] **M4 (5 issues)**:
  - E7-1 through E7-5 (Analytics)
  
- [ ] **M5 (4 issues)**:
  - E8-1 through E8-4 (Leads)
...
- [ ] **Sprint 1** — M1 issues (18 total); this is the active sprint starting immediately after Sprint 0
...
- [ ] Automated rules: PR creation → moves issue to "In Review"; PR merge → moves to "Done"
...
- [ ] PR/feature branches → Preview URL on Vercel (temporary)
...
- [ ] GitHub Actions logs show successful test runs (if already triggered)
...
### Documentation State
- [ ] `docs/Engineering/SPRINT_0_DONE.md` (this file) created
...
4. **Start with Issue #1**:
   - Issue: **E1-1: Scaffold Next.js + TypeScript + Tailwind + shadcn/ui**
   - Branch: `feature/e1-1-scaffold-nextjs`
...
7. **Next Issue**:
   - Once E1-1 PR is merged, move to E1-2
...
|--------|--------|-----------|
| Issues completed per week | 5-6 issues/week | Weekly |
...
3. **Review Test Examples**: Look at `tests/` directory for patterns
4. **Check ARCHITECTURE.md**: Verify you're following the tech stack choices (Next.js, Supabase, Prisma, etc.)
5. **Ask in Comments**: Leave a comment on the GitHub issue (or in Slack) with specific blockers
...
- **First Issue**: `docs/Engineering/SPRINT_1_START.md`
